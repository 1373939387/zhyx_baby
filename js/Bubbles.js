...
+ function() {
	...
	function Bubble() {
		...
		for (var i = 0; i < 4; i++) {
			...
			if (i == 3) {
				if (_IE6_)
					sty.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=./images/heart.png)";
				else
			...
			if (STD) {
				...
				sty.filter = "alpha progid:DXImageTransform.Microsoft.AlphaImageLoader(src=./images/ch" + i + ".png)";
